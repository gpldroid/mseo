...
const icons={"الذكاء الاصطناعي":"fa-robot","تطوير المواقع":"fa-code","تصميم المواقع":"fa-palette","البرمجة":"fa-js","SEO":"fa-chart-line","الأدوات والتقنيات":"fa-screwdriver-wrench","أداء المواقع":"fa-gauge-high"};
